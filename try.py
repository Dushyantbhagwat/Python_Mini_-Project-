...
# # #
# # #
# # # def generate_recruiters(num_records):
# # #     recruiters = []
# # #     for _ in range(num_records):
# # #         full_name = fake.name()
# # #         email_id = fake.email()
# # #         contact = fake.phone_number()
# # #         website = fake.webiste()
# # #         company_name = fake.company_website()
# # #
...
#
# <!--          </div>-->
# <!--          <div class="pdf2-wrapper">-->
# <!--              <a href="{% url 'accepted_recruiter_list' %}"><button class="pdf2">-->
# <!--                Accepted Recruiter-->
# <!--              </button></a>-->
# <!--          </div>-->
# <!--          <div class="pdf3-wrapper">-->
# <!--              <a href="{% url 'rejected_recruiter_list' %}"><button class="pdf3">-->
# <!--                Rejected Recruiter-->
# <!--              </button></a>-->
# <!--          </div>-->